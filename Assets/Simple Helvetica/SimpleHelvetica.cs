...
{
   public TextMesh TextMesh; // TextMesh 변수를 Text로 수정
    ...
    public void SetRandomWord()
{
    if (TextMesh != null)
    {
        TextMesh.text = "your_random_word_here"; // Text로 수정
    }
}
    ...
    public string[] words = { "apple", "nice", "good", "yes", "why", "sunwoo", "wonderful", "mix", "ice", "bag" };
   ...
   public void GenerateRandomWord()
{
    ...
    public void GenerateText()
    {
        ...
        //check all letters
        for (int ctr = 0; ctr < TextMesh.text.Length; ctr++) // Change Text.text to TextMesh.text
{
           ...
           if (TextMesh.text[ctr].ToString().ToCharArray()[0] == "\n"[0])
    {
        CharXLocation = 0;
        ...
        continue;
            ...
            string childObjectName = TextMesh.text[ctr].ToString();
	...
	public void ApplyMeshRenderer()
{
    ...
    UnityEngine.Rendering.ShadowCastingMode selfMeshRendererShadowCastingMode = selfMeshRenderer.shadowCastingMode;  // 수정된 부분
    bool selfMeshRendererReceiveShadows = selfMeshRenderer.receiveShadows;
    Material[] selfMeshRendererSharedMaterials = selfMeshRenderer.sharedMaterials;
    bool selfMeshRendererUseLightProbes = selfMeshRenderer.lightProbeUsage != UnityEngine.Rendering.LightProbeUsage.Off;
    Transform selfMeshRendererLightProbeAnchor = selfMeshRenderer.probeAnchor;
    ...
    foreach (Transform child in transform.Find("_Alphabets"))
    {
        ...
        {
            thisMeshRenderer.shadowCastingMode = selfMeshRendererShadowCastingMode;  // 수정된 부분
            thisMeshRenderer.receiveShadows = selfMeshRendererReceiveShadows;
            thisMeshRenderer.sharedMaterials = selfMeshRendererSharedMaterials;
            thisMeshRenderer.lightProbeUsage = selfMeshRendererUseLightProbes ? UnityEngine.Rendering.LightProbeUsage.BlendProbes : UnityEngine.Rendering.LightProbeUsage.Off;
            thisMeshRenderer.probeAnchor = selfMeshRendererLightProbeAnchor;
        }
    }
